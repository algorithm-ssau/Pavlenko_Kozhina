...
from main_dir.data.process_tag import convert_from_opencorpora_tag, process_gram_tag
from main_dir.data.word_form import WordFormOut
from main_dir.config import ModelBuild
...
class MorphoAnalysis(Predictor):
    def __init__(self):
        eval_model_config_path = "information/eval_model.json"
        eval_model_weights_path = "information/eval_model.h5"
        gram_dict_input = "information/gram_input.json"
        gram_dict_output = "information/gram_output.json"
        word_vocabulary = "information/vocabulary.txt"
        char_set_path = "information/char_set.txt"
        self.converter = converters.converter('opencorpora-int', 'ud14')
        self.morph = MorphAnalyzer()
        self.build_config = ModelBuild()
        self.model = LSTMAnalysis()
